...
const rf = require("../../assets/bl.png");
const lf = require("../../assets/br.png");
var LoopSlider = {
  currentIndex: 0,
  moveDis: 0,
  selector: "",
  ...
  init: function (obj) {
    ...
    _t.selector = obj.el;
    $(function () {
      if (obj.easing != null) _t.easing = obj.easing;
